  ...
  return (
    ...
    >
      ...
      <div className="container-x block mx-auto  pt-[370px] lg:pt-[96px] relative z-20">
          ...
          <div className="flex-1 lg:flex  ml-0 w-full mb-10 lg:mb-0">
            ...
            <div className="lg:w-[260px] w-full mb-10 lg:mb-0 mt-16 lg:mt-0">
              {firstCol && (
                <>
                  <div className="mb-5">
                    <h3 className="text-[18] font-500 text-white">
            ...
            <div className="lg:w-[260px] hidden xl:flex xl:flex-col w-full mb-10 lg:mb-0 relative">
              <div>
                {secondCol && (
                  <>
                    <div className="mb-5">
              ...
              <div className="w-[1px] xl:block hidden h-[250px] absolute left-[213px] bg-[#6B6B72]"></div>
            </div>
          </div>
          <div className="lg:w-[490px] lg:flex mt-16 lg:mt-0">
        ...
        <div
          className="bottom-bar border-t border-[#6B6B72] lg:h-[82px] flex lg:flex-row flex-col-reverse
         justify-between items-center"
        >
          <div className="flex lg:space-x-5 space-x-2.5 justify-between items-center my-3">
